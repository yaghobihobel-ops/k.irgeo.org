...
@section('panel')
    @if (request()->routeIs('admin.agent.deposit.list') || request()->routeIs('admin.agent.deposit.method'))
        @include('admin.agent_deposit.widget')
    @endif
    <div class="row">
        <div class="col-12">
                        ...
                        <x-admin.ui.table>
                            ...
                            <x-admin.ui.table.body>
                                @forelse($deposits as $deposit)
                                    <tr>
                                        <td>
                                            <x-admin.other.agent_info :agent="$deposit->agent" />
                                        ...
                                        <td>
                                            <a href="{{ route('admin.agent.deposit.details', $deposit->id) }}"
