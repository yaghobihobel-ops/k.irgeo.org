            ...
            <div class="row  mb-4 justify-content-center">
                <div class="col-sm-7">
                    <div class="row gy-4 justify-content-center">
                        @include('admin.merchants.notification_widget')
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-100" name="being_sent_to" required
                                        ...
                                        @foreach ($notifyToMerchant as $key => $toUser)
                                    ...
                                    <small class="text--info d-none userCountText mt-2 d-block"> <i class="las la-info-circle"></i>
                                        <strong class="userCount">0</strong> @lang('active merchants found to send the notification')</small>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start"
                                                ...
                                                placeholder="@lang('Start form merchant id. e.g. 1')" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input--group">
                                                <input class="form-control" name="batch"
                                                    ...
                                                    placeholder="@lang('How many merchant')" required>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDMERCHANTS') {
                    $('.input-append').html(`
                ...
                if (methodName == 'TOPDEPOSITEDMERCHANTS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required form-label">@lang('Number Of Top Deposited Merchant')</label>
                ...
                if (methodName == 'NOTLOGINMERCHANTS') {
                    $('.input-append').html(`
                    <div class="form-group">
            ...
            function fetchUserList() {
                ...
                $('.row #user_list').select2({
                    ajax: {
                        url: "{{ route('admin.merchants.list') }}",
                        type: "get",
                        dataType: 'json',
                        delay: 1000,
                        ...
                        processResults: function(response, params) {
                            ...
                            let data = response.merchants.data;
                            return {
            ...
            function getUserCount(methodName) {
                ...
                if (methodNameUpper == 'SELECTEDMERCHANTS' || methodNameUpper == 'ALLMERCHANTS' || methodNameUpper ==
                    'TOPDEPOSITEDMERCHANTS' ||
                    methodNameUpper == 'NOTLOGINMERCHANTS') {
                    $('.userCount').text(0);
                    $('.userCountText').addClass('d-none');

                    return;
                }
                var route = "{{ route('admin.merchants.segment.count', ':methodName') }}"
