...
@section('panel')
        ...
        <div class="col-lg-8">
            <x-admin.ui.card>
                <x-admin.ui.card.body>
                    ...
                    @if ($merchant->kv == Status::KYC_UNVERIFIED)
                        <div class="my-3">
                    ...
                    @if ($merchant->kv == Status::KYC_PENDING)
                        <div class="d-flex flex-wrap justify-content-end mt-3">
                            ...
                            <button class="btn btn-outline--success confirmationBtn" data-question="@lang('Are you sure to approve this documents?')"
                                data-action="{{ route('admin.merchants.kyc.approve', $merchant->id) }}">
    ...
    <x-admin.ui.modal id="kycRejectionModal">
        ...
        <x-admin.ui.modal.body>
            <form action="{{ route('admin.merchants.kyc.reject', $merchant->id) }}" method="POST">
                @csrf
                <div class="alert alert-primary p-3">
                    @lang('If you reject these documents, the merchant will be able to re-submit new documents and these documents will be replaced by new documents.')
                </div>
