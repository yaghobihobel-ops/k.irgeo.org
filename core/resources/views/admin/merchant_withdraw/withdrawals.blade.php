...
@section('panel')
    @if (request()->routeIs('admin.withdraw.merchant.data.all') || request()->routeIs('admin.withdraw.method'))
        @include('admin.merchant_withdraw.widget')
    @endif
    <div class="row">
        <div class="col-12">
            <x-admin.ui.card class="table-has-filter">
                <x-admin.ui.card.body :paddingZero="true">
                    <x-admin.ui.table.layout searchPlaceholder="Username / TRX" filterBoxLocation="merchant_withdraw.filter_form">
                        <x-admin.ui.table>
                            ...
                            <x-admin.ui.table.body>
                                @forelse($withdrawals as $withdraw)
                                    <tr>
                                        <td>
                                            <x-admin.other.merchant_info :merchant="$withdraw->merchant" />
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.withdraw.merchant.data.details', $withdraw->id) }}"
