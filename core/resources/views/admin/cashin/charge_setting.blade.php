...
@section('panel')
    <form action="{{ route('admin.cashin.charge.setting.update') }}" method="POST" enctype="multipart/form-data"
        id="charge-form">
        @csrf
        <div class="row  gy-4">
            ...
            <div class="col-xxl-4 col-sm-6">
                <x-admin.ui.card>
                    <x-admin.ui.card.header>
                        <h4 class="card-title">@lang('Agent Commission')</h4>
                    </x-admin.ui.card.header>
                    <x-admin.ui.card.body>
                        <div class="form-group">
                            <label class="form-label">@lang('Fixed Commission')</label>
                            <div class="input-group input--group">
                                <input type="number" step="any" class="form-control" name="agent_commission_fixed"
                                    value="{{ getAmount($charge->agent_commission_fixed) }}" required>
                                <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label">@lang('Percent Commission')</label>
                            <div class="input-group input--group">
                                <input type="number" step="any" class="form-control" name="agent_commission_percent"
                                    value="{{ getAmount($charge->agent_commission_percent) }}" required>
            ...
            <div class="col-xxl-4 col-sm-6">
                <x-admin.ui.card class="h-100">
                    <x-admin.ui.card.header>
                        <h4 class="card-title">@lang('Commission  Cap')</h4>
                    </x-admin.ui.card.header>
                    <x-admin.ui.card.body>
                        <div class="form-group">
                            <label class="form-label">
