...
@section('panel')
    <form action="{{ route('admin.gateway.manual.store') }}" class="disableSubmission" method="POST"
        ...
        <div class="row gy-4">
            ...
            <div class="col-12">
                <div class="card border border--gray h-100">
                    <h5 class="card-header bg--gray fs-20">@lang('Add Money Instruction')</h5>
                    <div class="card-body">
                        <div class="form-group">
            ...
            <div class="col-lg-12">
                ...
                <x-generated-form generateTitle="Generate User Data Form" formTitle="User Data Form"
                    ...
                    generateSubTitle="Create user data forms to capture required data from the users on add money via this gateway." />
            </div>
            <div class="col-12">
