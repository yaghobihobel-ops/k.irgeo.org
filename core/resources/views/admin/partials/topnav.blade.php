...
<header class="dashboard__header">
    ...
    <div class="dashboard-info flex-align gap-sm-2 gap-1">
        ...
        <x-permission_check :permission="['view user add money','view user add money','view agent withdraw','view user tickets','update general settings','system configuration','notification settings','view users']">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="quick-link-list">
                        ...
                        <x-permission_check permission="view agent withdraw">
                            <a href="{{ route('admin.withdraw.data.pending') }}" class="quick-link-item">
                                <span class="quick-link-item__icon">
                        ...
                        <x-permission_check permission="view user tickets">
                            <a href="{{ route('admin.ticket.user.pending') }}" class="quick-link-item">
                                <span class="quick-link-item__icon">
                        ...
                        <x-permission_check permission="update general settings">
                        ...
                        <x-permission_check permission="view users">
        ...
        <x-permission_check permission="view all notifications">
