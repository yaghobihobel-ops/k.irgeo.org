            ...
            <div class="row  mb-4 justify-content-center">
                <div class="col-sm-7">
                    <div class="row gy-4 justify-content-center">
                        @include('admin.agents.notification_widget')
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 select2-100" name="being_sent_to" required
                                        ...
                                        @foreach ($notifyToAgent as $key => $toUser)
                                    ...
                                    <small class="text--info d-none userCountText mt-2 d-block"> <i class="las la-info-circle"></i>
                                        <strong class="userCount">0</strong> @lang('active agents found to send the notification')</small>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="start"
                                                ...
                                                placeholder="@lang('Start form agent id. e.g. 1')" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input--group">
                                                <input class="form-control" name="batch"
                                                    ...
                                                    placeholder="@lang('How many agent')" required>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'TOPDEPOSITEDAGENTS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required form-label">@lang('Number Of Top Deposited Agent')</label>
            ...
            function getUserCount(methodName) {
                ...
                if (methodNameUpper == 'SELECTEDAGENTS' || methodNameUpper == 'ALLAGENTS' || methodNameUpper ==
                    'TOPDEPOSITEDAGENTS' ||
                    methodNameUpper == 'NOTLOGINAGENTS') {
                    $('.userCount').text(0);
                    $('.userCountText').addClass('d-none');

                    return;
                }
                var route = "{{ route('admin.agents.segment.count', ':methodName') }}"
