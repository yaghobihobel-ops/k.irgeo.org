...
@section('panel')
    <form action="{{ route('admin.send.money.charge.setting.update') }}" method="POST" enctype="multipart/form-data"
        id="charge-form">
        @csrf
        <div class="row  gy-4">
            <div class="col-sm-4">
            ...
            <div class="col-xxl-4 col-sm-6">
                <x-admin.ui.card class="h-100">
                    ...
                    <x-admin.ui.card.body>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                @lang('Daily Request Accept Limit')
                            </label>
                            <span title="@lang('Put -1 for unlimited')">
                                <i class="las la-info-circle"></i>
                            </span>
                            <div class="input-group input--group">
                                <input type="number" step="any" class="form-control" name="daily_request_accept_limit"
                                    value="{{ getAmount($charge->daily_request_accept_limit) }}" required>
                                <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                            </div>
                        </div>
                    </x-admin.ui.card.body>
            ...
            <div class="col-xxl-4 col-sm-6">
                <x-admin.ui.card class="h-100">
                    ...
                    <x-admin.ui.card.body>
                        ...
                        <div class="form-group">
                            <label class="form-label">
                                @lang('Monthly Request Accept Limit')
                            </label>
                            <span title="@lang('Put -1 if you don\'t want a limit')">
                                <i class="las la-info-circle"></i>
                            </span>
                            <div class="input-group input--group">
                                <input type="number" step="any" class="form-control"
                                    name="monthly_request_accept_limit"
                                    value="{{ getAmount($charge->monthly_request_accept_limit) }}" required>
                                <div class="input-group-text">{{ __(gs('cur_text')) }}</div>
                            </div>
                        </div>
                    </x-admin.ui.card.body>
