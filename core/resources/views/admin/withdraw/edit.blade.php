        ...
        <div class="row gy-4">
            ...
            <div class="col-lg-6">
                <div class="card border border--gray h-100">
                    <h5 class="card-header bg--gray fs-20">@lang('Range for Agent')</h5>
                    <div class="card-body">
                        <div class="form-group">
            ...
            <div class="col-lg-6">
                <div class="card border border--gray h-100">
                    <h5 class="card-header bg--gray fs-20">@lang('Charge for Agent')</h5>
                    <div class="card-body">
                        <div class="form-group">
            ...
            <div class="col-lg-6">
                <div class="card border border--gray h-100">
                    <h5 class="card-header bg--gray fs-20">@lang('Range for Merchant')</h5>
                    <div class="card-body">
                        <div class="form-group">
                            <label>@lang('Minimum Amount')</label>
                            <div class="input-group input--group">
                                <input type="text" class="form-control minLimit" name="merchant_min_limit"
                                    value="{{ getAmount($method->merchant_min_limit) }}" required />
                                <span class="input-group-text"> {{ __(gs('cur_text')) }} </span>
                            </div>
                            <span class="text--danger fs-13 d-none minimum-error">@lang('The minimum amount must be greater than the fixed charge')</span>
                        </div>
                        <div class="form-group">
                            <label>@lang('Maximum Amount')</label>
                            <div class="input-group input--group">
                                <input type="text" class="form-control" name="merchant_max_limit"
                                    value="{{ getAmount($method->merchant_max_limit) }}" required />
                                <span class="input-group-text"> {{ __(gs('cur_text')) }} </span>
                            </div>
                            <span class="text--danger fs-13 maximum-error d-none">@lang('The maximum amount must be greater than the minimum amount')</span>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="card border border--gray h-100">
                    <h5 class="card-header bg--gray fs-20">@lang('Charge for Merchant')</h5>
                    <div class="card-body">
                        <div class="form-group">
                            <label>@lang('Fixed Charge')</label>
                            <div class="input-group input--group">
                                <input type="text" class="form-control" name="merchant_fixed_charge"
                                    value="{{ getAmount($method->merchant_fixed_charge) }}" required />
                                <span class="input-group-text"> {{ __(gs('cur_text')) }} </span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>@lang('Percent Charge')</label>
                            <div class="input-group input--group">
                                <input type="text" class="form-control" name="merchant_percent_charge"
                                    value="{{ getAmount($method->merchant_percent_charge) }}" required>
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
