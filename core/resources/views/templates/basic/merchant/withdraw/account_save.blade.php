...
@section('content')
    <div class="row justify-content-center justify-content-xl-start">
        <div class="col-12">
            <h4 class="mb-4">
                <a href="{{ route('merchant.withdraw.account.setting') }}">
        ...
        <div class="col-xxl-6 col-xl-8 col-lg-8">
            <div class="card custom--card h-100">
                <div class="card-body">
                    ...
                    <hr>
                    <form method="POST" action="{{ route('merchant.withdraw.account.save.data') }}"
                    ...
                    <ul class="list-group list-group-flush mb-4">
                        @forelse ($savedAccounts as $savedAccount)
                            <li class="list-group-item d-flex gap-2 flex-wrap justify-content-between ps-0">
                                ...
                                <span>
                                    <a href="{{ route('merchant.withdraw.account.edit', $savedAccount->id) }}"
                                    ...
                                    <button class="btn btn--danger btn--sm confirmationBtn"
                                        ...
                                        data-action="{{ route('merchant.withdraw.account.delete', $savedAccount->id) }}"><i
