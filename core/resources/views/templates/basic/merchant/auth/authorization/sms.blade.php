            ...
            <div class="account-form">
                ...
                <div class="account-form__content text-center">
                    ...
                    <p class="account-form__desc">
                        ...
                        <span class="number">{{ showMobileNumber(auth('merchant')->user()->mobileNumber) }}</span>
                    </p>
                </div>
                <form action="{{ route('merchant.verify.mobile') }}" method="POST" class="submit-form verify-form">
                    @csrf
                    <div class="otp-inner">
        ...
        var x = setInterval(function() {
            ...
            if (distance <= 0) {
                ...
                $(".resend-link").removeClass('cursor-select-none').attr('href',
                    "{{ route('merchant.send.verify.code', 'sms') }}");
