    ...
    <div class="invoice-area">
            ...
            <table>
                <tr>
                    ...
                    <td class="pdf-top-right">
                        <h2 class="pdf-top-title">@lang('Donation Successful!')</h2>
                        <p class="pdf-top-text">@lang('Your donation has been successfully done.')</p>
                    </td>
                </tr>
            </table>
        </div>
        <div class="pdf-details">
            <table>
                <tbody>
                    <tr>
                        <td class="pdf-info-title">@lang('Charity')</td>
                        <td class="pdf-info-value">{{ @$donation->donationFor->name }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">@lang('TRX')</td>
                        <td class="pdf-info-value">{{ $donation->trx }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">@lang('Time')</td>
                        <td class="pdf-info-value">{{ showDateTime($donation->created_at) }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">@lang('Amount')</td>
                        <td class="pdf-info-value">{{ showAmount($donation->amount) }}</td>
                    </tr>
                    <tr class="total">
                    ...
                    <tr class="current-balance">
                        ...
                        <td class="pdf-info-value">{{ showAmount($donation->post_balance) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
