        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Donation Successful!')</h4>
                        <p class="desc">@lang('Your donation has been successfully done.')</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Charity')</span>
                        <span class="desc">{{ @$donation->donationFor->name }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('TRX ID')</span>
                        <span class="desc">{{ $donation->trx }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($donation->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($donation->amount) }}</span>
                    </div>
                ...
                <div class="payment-balance mb-4 mb-sm-5">
                    ...
                    <span class="amount">{{ showAmount($donation->post_balance) }}</span>
                </div>

                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4">
                    <a href="{{ route('user.donation.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                        ...
                        @lang('Donation History')
                    </a>

                   
                    <a href="{{ route('user.donation.pdf', $donation->id) }}" class="btn btn--base flex-grow-1">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
