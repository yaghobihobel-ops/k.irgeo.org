                    ...
                    <div class="card custom--card ">
                        <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            @if ($myTicket->status != Status::TICKET_CLOSE && $myTicket->user)
                                <button class="btn btn--sm btn--danger close-button  confirmationBtn" type="button"
                    ...
                    <div class="card custom--card mt-4">
                        <div class="card-body">
                            @forelse($messages as $message)
                                ...
                                @else
                                    <div class="row border border-warning rounded-2 my-3 py-3 mx-2 reply-bg">
                                        <div class="col-md-3 border-end text-end">
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group style-two">
                                ...
                                <button type="button" class="input-group-text text-white removeFile bg--danger border--danger"><i class="las la-times"></i></button>
                            </div>
                        </div>
                    </div>
                `)
