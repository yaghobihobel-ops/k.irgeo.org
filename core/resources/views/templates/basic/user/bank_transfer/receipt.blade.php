        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Bank Transfer Successful!')</h4>
                        <p class="desc">@lang('Your bank transfer has been successfully done.')</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Bank')</span>
                        <span class="desc">{{ __(@$bankTransfer->bank->name) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Account Holder')</span>
                        <span class="desc">{{ __(@$bankTransfer->account_holder) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Account Number')</span>
                        <span class="desc">{{ __(@$bankTransfer->account_number) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('TRX ID')</span>
                        <span class="desc">{{ $bankTransfer->trx }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($bankTransfer->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($bankTransfer->amount) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Charge')</span>
                        <span class="desc">{{ showAmount($bankTransfer->charge) }}</span>
                    </div>

                    <div class="payment-info-item total">
                        <span class="title">@lang('Total')</span>
                        <span class="desc">{{ showAmount($bankTransfer->total) }}</span>
                    </div>
                ...
                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4 mt-4">
                    <a href="{{ route('user.bank.transfer.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                        ...
                        @lang('Bank Transfer History')
                    </a>


                    <a href="{{ route('user.bank.transfer.pdf', $bankTransfer->id) }}"
                        class="btn btn--base flex-grow-1">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
