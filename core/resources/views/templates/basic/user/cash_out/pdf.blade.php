            ...
            <table>
                <tr>
                    ...
                    <td class="pdf-top-right">
                        <h2 class="pdf-top-title">@lang('Cash Out Successful!')</h2>
                        <p class="pdf-top-text">@lang('Your cash out has been successfully done.')</p>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="pdf-info-value">{{ $cashOut->trx }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">@lang('Time')</td>
                        <td class="pdf-info-value">{{ showDateTime($cashOut->created_at) }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">@lang('Amount')</td>
                        <td class="pdf-info-value">{{ showAmount($cashOut->amount) }}</td>
                    </tr>
                    <tr>
                        <td class="pdf-info-title">(+) @lang('Charge')</td>
                        <td class="pdf-info-value">{{ showAmount($cashOut->charge) }}</td>
                    </tr>
                    <tr class="total">
                        <td class="pdf-info-title">@lang('Total')</td>
                        <td class="pdf-info-value">{{ showAmount($cashOut->total_amount) }}</td>
                    </tr>
                    <tr class="current-balance">
                        <td class="pdf-info-title">@lang('Post Balance')</td>
                        <td class="pdf-info-value">{{ showAmount($cashOut->user_post_balance) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
