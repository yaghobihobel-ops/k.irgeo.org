        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Education Fee Payment Successful!')</h4>
                        <p class="desc">@lang('Your education fee has been successfully done.')</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Institute')</span>
                        <span class="desc">{{ __(@$educationFee->institution->name) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('TRX ID')</span>
                        <span class="desc">{{ $educationFee->trx }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($educationFee->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($educationFee->amount) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Charge')</span>
                        <span class="desc">{{ showAmount($educationFee->charge) }}</span>
                    </div>

                    <div class="payment-info-item total">
                        <span class="title">@lang('Total')</span>
                        <span class="desc">{{ showAmount($educationFee->total) }}</span>
                    </div>
                ...
                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4 mt-4">
                    <a href="{{ route('user.education.fee.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                        ...
                        @lang('Education Fee History')
                    </a>

                   
                    <a href="{{ route('user.education.fee.pdf', $educationFee->id) }}" class="btn btn--base flex-grow-1">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
