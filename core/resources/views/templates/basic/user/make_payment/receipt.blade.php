            ...
            <div class="card-body">
                ...
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Merchant')</span>
                        <span class="desc">{{ @$makePayment->merchant->mobile }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('TRX ID')</span>
                        <span class="desc">{{ $makePayment->trx }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($makePayment->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($makePayment->amount) }}</span>
                    </div>
                ...
                <div class="payment-balance mb-4 mb-sm-5">
                    ...
                    <span class="amount">{{ showAmount($makePayment->user_post_balance) }}</span>
                </div>

                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4">
                    <a href="{{ route('user.make.payment.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                        ...
                        @lang('Make Payment History')
                    </a>

                   
                    <a href="{{ route('user.make.payment.pdf', $makePayment->id) }}" class="btn btn--base flex-grow-1">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
