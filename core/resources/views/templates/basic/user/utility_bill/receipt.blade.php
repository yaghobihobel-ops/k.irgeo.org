        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Bill Payment Successful!')</h4>
                        <p class="desc">@lang('Your bill payment has been successfully done.')</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="payment-info">
                    <div class="payment-info-item">
                        ...
                        <span class="desc">{{ __(@$utilityBill->company->name) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Unique ID')</span>
                        <span class="desc">{{ __(@$utilityBill->unique_id) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('TRX ID')</span>
                        <span class="desc">{{ $utilityBill->trx }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($utilityBill->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($utilityBill->amount) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Charge')</span>
                        <span class="desc">{{ showAmount($utilityBill->charge) }}</span>
                    </div>
                    <div class="payment-info-item total">
                        <span class="title">@lang('Total')</span>
                        <span class="desc">{{ showAmount($utilityBill->total) }}</span>
                    </div>
                    <div class="payment-info-item total">
                ...
                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4 mt-4">
                    <a href="{{ route('user.utility.bill.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                        ...
                        @lang('Utility Bill History')
                    </a>


                    <a href="{{ route('user.utility.bill.pdf', $utilityBill->id) }}" class="btn btn--base flex-grow-1">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                                fill="none">
                                <path
