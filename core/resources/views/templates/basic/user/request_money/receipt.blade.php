        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Request Money Successful!')</h4>
            ...
            <div class="card-body">
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Request To')</span>
                        <span class="desc">
                            {{ @$requestMoney->requestReceiver->mobile }}
                        </span>
                    </div>
                    <div class="payment-info-item">
                ...
                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4 mt-4">
                    <a href="{{ route('user.request.money.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                    ...
                    <a href="{{ route('user.request.money.pdf', $requestMoney->id) }}"
