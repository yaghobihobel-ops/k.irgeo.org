        ...
        <div class="card custom--card">
            <div class="card-header">
                <div class="payment-info-top">
                    ...
                    <div class="content">
                        <h4 class="title">@lang('Received Request Money Successful!')</h4>
                        <p class="desc">@lang('Your request money has been successfully done.')</p>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="payment-info">
                    <div class="payment-info-item">
                        <span class="title">@lang('Request From')</span>
                        <span class="desc">
                            {{ @$requestMoney->requestSender->mobile }}
                        </span>
                    </div>

                    <div class="payment-info-item">
                        <span class="title">@lang('Transaction ID')</span>
                        <span class="desc">{{ $requestMoney->trx }}</span>
                    </div>


                    <div class="payment-info-item">
                        <span class="title">@lang('Time')</span>
                        <span class="desc">{{ showDateTime($requestMoney->created_at) }}</span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Amount')</span>
                        <span class="desc">{{ showAmount($requestMoney->amount) }}</span>
                    </div>
                    <div class="payment-info-item total">
                        <span class="title">@lang('Note')</span>
                        <span class="desc">{{ __($requestMoney->note) ?? '-' }}</span>
                    </div>
                    <div class="payment-info-item total">
                ...
                <div class="payment-btn-wrapper flex-align gap-3 gap-lg-4 mt-4">
                    <a href="{{ route('user.request.money.received.history') }}" class="btn btn--light flex-grow-1">
                        <span class="icon">
                    ...
                    <a href="{{ route('user.request.money.received.pdf', $requestMoney->id) }}"
