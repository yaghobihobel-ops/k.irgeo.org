...
<div class="sidebar-menu">
    ...
    <div class="sidebar-logo">
        <a href="{{ route('merchant.home') }}" class="sidebar-logo__link">
    ...
    <ul class="sidebar-menu-list mt-4">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.home') }}">
            <a href="{{ route('merchant.home') }}" class="sidebar-menu-list__link">
                <span class="icon">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.payment.*') }}">
            <a href="{{ route('merchant.payment.list') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
                            ...
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M13.5 17H17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M13.5 7H17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M13.5 12H17.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M6.5 16.5C6.5 16.5 7.46758 16.7672 8 18C8 18 9 15 11 14" stroke="currentColor"
                            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                ...
                <span class="text">@lang('Manage Payment')</span>
            </a>
        </li>
        <li class="sidebar-menu-list__item {{ menuActive('merchant.withdraw*') }}">
            <a href="{{ route('merchant.withdraw.history') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.statement.*') }}">
            <a href="{{ route('merchant.statement.history') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.transaction*') }}">
            <a href="{{ route('merchant.transactions') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.profile.setting') }}">
            <a href="{{ route('merchant.profile.setting') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.change.password') }}">
            <a href="{{ route('merchant.change.password') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.twofactor') }}">
            <a href="{{ route('merchant.twofactor') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item {{ menuActive('merchant.notification.setting') }}">
            <a href="{{ route('merchant.notification.setting') }}" class="sidebar-menu-list__link">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20"
                        fill="none">
                        <path
        ...
        <li class="sidebar-menu-list__item">
            <a href="{{ route('merchant.logout') }}" class="sidebar-menu-list__link log-out mt-2">
                <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                        fill="none">
                        <path
