...
@section('content')
    <h4 class="mb-4">
        <a href="{{ route('agent.withdraw.history') }}">
    ...
    <div class="col-lg-9">
        <form action="{{ route('agent.withdraw.money') }}" method="post" class="withdraw-form">
            @csrf
                        ...
                        <div class="payment-system-list is-scrollable gateway-option-list">
                            ...
                            <div class="save-accounts-list d-none">
                                <div class="form-group mt-3">
                                    <label for="" class="form--label">@lang('Saved Account')</label>
                            ...
                            <div class="deposit-info">
                                ...
                                <div class="deposit-info__input">
                                    <div class="deposit-info__input-group input-group">
                                        <span
                                            class="deposit-info__input-group-text input-group-text">{{ gs('cur_sym') }}</span>
    ...
    <script>
        ...
        (function($) {
            ...
            function showSaveAccounts() {
                ...
                saveAccountsSelect.append('<option value="" selected disabled>@lang("Select save account")</option>');
