...
class WithdrawMethodController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validation = [
            ...
            'merchant_fixed_charge'   => 'required|numeric|gte:0',
            'merchant_percent_charge' => 'required|numeric|between:0,100',
            'merchant_min_limit'      => 'required|numeric|gt:fixed_charge',
            'merchant_max_limit'      => 'required|numeric|gt:min_limit',
        ...
        $method->merchant_min_limit      = $request->merchant_min_limit;
        $method->merchant_max_limit      = $request->merchant_max_limit;
        $method->merchant_fixed_charge   = $request->merchant_fixed_charge;
        $method->merchant_percent_charge = $request->merchant_percent_charge;
